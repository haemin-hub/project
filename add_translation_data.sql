...
WHEN MATCHED THEN
  UPDATE SET
    ...
    t.NAME_LABEL    = COALESCE(s.NAME_TR,    t.NAME_LABEL,    (SELECT i.NAME    FROM C##HEALNGO.ITEM_LIST i WHERE i.ID = t.ITEM_ID)),
    t.ADDRESS_LABEL = COALESCE(s.ADDRESS_TR, t.ADDRESS_LABEL, (SELECT i.ADDRESS FROM C##HEALNGO.ITEM_LIST i WHERE i.ID = t.ITEM_ID))
