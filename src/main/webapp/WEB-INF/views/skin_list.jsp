                ...
                <div class="filter-row">
                    <div class="filter-checkboxes">
                        <label class="filter-checkbox">
                            ...
                            <span class="checkmark"><spring:message code="filter.skin.laser"/></span>
                        </label>
                        <label class="filter-checkbox">
                            <input type="checkbox" name="category" value="nose">
                            <span class="checkmark"><spring:message code="filter.skin.booster"/></span>
                        </label>
                        <label class="filter-checkbox">
                            <input type="checkbox" name="category" value="chin">
                            <span class="checkmark"><spring:message code="filter.skin.botox"/></span>
                        </label>
                        <label class="filter-checkbox">
                            <input type="checkbox" name="category" value="mouth">
                            <span class="checkmark"><spring:message code="filter.skin.lifting"/></span>
                        </label>
                        <label class="filter-checkbox">
                            <input type="checkbox" name="category" value="chest">
                            <span class="checkmark"><spring:message code="filter.skin.exfoliation"/></span>
                        </label>
                    </div>
                </div>
            </div>
