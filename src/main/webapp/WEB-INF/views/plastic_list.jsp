                    ...
                    <div class="filter-row">
                        <div class="filter-checkboxes">
                            <label class="filter-checkbox">
                                ...
                                <span class="checkmark"><spring:message code="filter.plastic.eye"/></span>
                            </label>
                            <label class="filter-checkbox">
                                <input type="checkbox" name="category" value="nose">
                                <span class="checkmark"><spring:message code="filter.plastic.nose"/></span>
                            </label>
                            <label class="filter-checkbox">
                                <input type="checkbox" name="category" value="chin">
                                <span class="checkmark"><spring:message code="filter.plastic.chin"/></span>
                            </label>
                            <label class="filter-checkbox">
                                <input type="checkbox" name="category" value="mouth">
                                <span class="checkmark"><spring:message code="filter.plastic.mouth"/></span>
                            </label>
                            <label class="filter-checkbox">
                                <input type="checkbox" name="category" value="chest">
                                <span class="checkmark"><spring:message code="filter.plastic.chest"/></span>
                            </label>
                            <label class="filter-checkbox">
                                <input type="checkbox" name="category" value="liposuction">
                                <span class="checkmark"><spring:message code="filter.plastic.liposuction"/></span>
                            </label>
                        </div>
                    </div>
                </div>
